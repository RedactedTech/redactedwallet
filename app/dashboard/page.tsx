                ...
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      title={copiedText === recoveryWallet.derivation_path ? "Copied!" : "Copy derivation path"}
                    >
                      {copiedText === recoveryWallet.derivation_path ? (
                        <>
                          <svg className="w-4 h-4 text-green-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                          </svg>
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      className="relative text-gray-400 hover:text-white transition-colors p-2"
                      title={copiedText === recoveryWallet.public_key ? "Copied!" : "Copy public key"}
                    >
                      {copiedText === recoveryWallet.public_key ? (
                        <>
                          <svg className="w-4 h-4 text-green-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                          </svg>
                          <span className="absolute -top-8 left-1/2 -translate-x-1/2 bg-green-500 text-white text-xs px-2 py-1 rounded whitespace-nowrap animate-fade-in z-50">
                            Copied!
                          </span>
                        </>
                      ) : (
